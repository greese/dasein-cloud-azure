...
public class AzureOSImage extends AbstractImageSupport {
    ...
    static private final String RESOURCE_VMIMAGES = "/services/vmimages?location=%s";
    ...
    private ArrayList<MachineImage> getVMImages() throws CloudException, InternalException
    {
        ...
        ArrayList<MachineImage> images = new ArrayList<MachineImage>();
        AzureMethod azureMethod = new AzureMethod(provider);
        VMImagesModel vmImagesModel = azureMethod.get(VMImagesModel.class, String.format(RESOURCE_VMIMAGES, URLEncoder.encode(ctx.getRegionId())));
