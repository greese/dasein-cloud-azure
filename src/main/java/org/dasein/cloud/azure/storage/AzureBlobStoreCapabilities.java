...
public class AzureBlobStoreCapabilities extends AbstractCapabilities<Azure> implements BlobStoreCapabilities {
    ...
    public AzureBlobStoreCapabilities(Azure provider) {
        super(provider);
    }
